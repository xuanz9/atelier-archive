...
const artworks = [
  ...
  { id: 3, title: 'After the Rain', artist: 'Inez Calder', year: 2024, medium: 'Mixed media', dimensions: '30 × 42 in', price: '$3,900', status: 'Available', image: 'https://images.unsplash.com/photo-1646782013671-66599767f714?auto=format&fit=crop&w=1400&q=85', aspect: 'aspect-[4/5]' },
  { id: 4, title: 'Blue Hour', artist: 'Mara Voss', year: 2022, medium: 'Oil on panel', dimensions: '24 × 30 in', price: 'Sold', status: 'Sold', image: 'https://images.unsplash.com/photo-1676200832719-35b267832b04?auto=format&fit=crop&w=1400&q=85', aspect: 'aspect-[4/5]' },
